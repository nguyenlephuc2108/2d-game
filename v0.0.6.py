...
#function
class player():
    def __init__(self, type_move, xn, yn, xl, yl, width, height, speed, color):
...
#create player
player_a = player('arrow', ratio*100, ratio*100, ratio*100, ratio*100, ratio*20, ratio*20, ratio*3, red)
